...
const aboutModale: React.FC<ModalProps> = ({ isOpen, onClose, triggerButtonRef }) => {
  ...
  return (
    ...
    >
      <div
        className="bg-white p-8 rounded-lg shadow-lg w-full h-full"
        ref={modalRef}
